...
content = re.sub(r'<div class="spectrum-bar"[^>]*onmousedown="window\.startSpectrum\(event, \'pill-bulk\', \$\{index\}\)"[^>]*></div>', r'<div class="pill-color-dot rainbow" title="Espectro Completo" onclick="window.openFullPicker(event, \'pill\', ${index})"></div>', content)
