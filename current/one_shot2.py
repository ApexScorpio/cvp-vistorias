def run():
    ...
    # Remove dangling openFullPicker
    ...
    # Remove dangling const rect = e.currentTarget.getBoundingClientRect(); that had NO function wrapper!
    ...
    # Now let's do the HTML replacements for the pill-palette
