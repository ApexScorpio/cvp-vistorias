...
v_Traseira_Esq = "1- Risco de 0 a 50 mm"
...
Observações = """ Fuga de oxigénio no ventilador
Gaveta de baixo do armário não fecha"""


Danos_Viatura = """BF
Parachoques picado á frente"""


#       pyinstaller BF-Relatorio.py --onefile
