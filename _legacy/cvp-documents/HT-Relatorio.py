...
v_Para_Lamas_Drt = "3- Mossa + Pintura"
...
v_Porta_Traseira_Esq = "2- Raspado"
v_Porta_Traseira_Drt = "3- Mossa + Pintura"
v_Tejadilho = ""
v_resposta10 = ""
...
Observações = """HT
Lanterna sem carga
Roda de regulação da inclinação do banco do condutor partida
Banco do condutor rasgado
Clip Leitura de Mapas Partido
"""


Danos_Viatura = """Reflector traseiro esq partido
"""
...
seleccao_funcionamento = [Rádio_de_comunicações, Buzina, Esguichos_dos_lava_vidros, Luzes_minimos, Luzes_medios, Luzes_maximos, Luzes_stop, Luzes_marcha_atras, Luz_nevoeiro, Piscas_FR_TR, Rotativos_Ponte, Sirene, Iluminacao_chapa_matricula, Estoboscopios, Iluminacao_interior, Cintos, Retrovisores, Fechaduras, Travoes, Projetores_laterais]
...
seleccao_riscos = [Para_Choques, Porta_Condutor, Painel_Esq, Painel_Esq, Traseira_Esq, Para_Lamas_Drt, Porta_Passageiro, Porta_Lateral, Traseira_Drt, Para_Choques_Traseiro, Porta_Traseira_Esq]
...
#       pyinstaller HT-Relatorio.py --onefile