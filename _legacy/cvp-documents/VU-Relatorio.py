...
Condutor = "Miguel"
Turno = 'Outros'        #  08:00 às 20:00 - INEM      20:00 às 08:00 - INEM       Outros - SERVIÇO GERAL
Matricula = "OUTRA"   #  OUTRA
Kilometros= "15"
...
v_Capô = ""
v_Para_Lamas_Esq = "3- Mossa + Pintura"
v_Para_Lamas_Drt = ""
v_Tejadilho = ""
v_Porta_Condutor = "2- Raspado"
...
Agua no nível mínimo
Extintor sem a cavilha de segurança 
Botão do vidro do condutor solto
Primeira gaveta do armário não se mantem fechada
Cinto de segurança do banco de costas (célula) não retrai
Inversor(?) por vezes faz um apito continuo quando o 220v é ligado, que fica até ser desligado """


Danos_Viatura = "Ferro de suporte do capô com o encaixe partido" 


#   pyinstaller VU-Relatorio.py --onefile
...
seleccao_riscos = [Para_Choques, Para_Lamas_Esq, Porta_Condutor, Porta_Passageiro, Painel_Esq, Traseira_Esq, Traseira_Drt, Para_Choques_Traseiro]
