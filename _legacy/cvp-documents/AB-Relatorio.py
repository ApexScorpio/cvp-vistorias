...
v_Sirene = "BOM"
v_Iluminacao_chapa_matricula = "REVER"
v_Estoboscopios = "BOM"
v_Iluminacao_interior = "BOM"
v_Rádio_de_comunicações = "BOM"
v_Cintos = "BOM"
v_Retrovisores = "BOM"
v_Fechaduras = "BOM"
v_Travoes = "REVER"
...
v_Capô = "3- Mossa + Pintura"
v_Para_Lamas_Esq = ""
v_Para_Lamas_Drt = ""
v_Tejadilho = ""
v_Porta_Condutor = "1- Risco de 0 a 50 mm"
v_Porta_Passageiro = "1- Risco de 0 a 50 mm"
v_Painel_Esq = "3- Mossa + Pintura"
v_Porta_Lateral = "3- Mossa + Pintura"
v_resposta10 = "1- Risco de 0 a 50 mm"
v_Traseira_Esq = "3- Mossa + Pintura"
v_Traseira_Drt = "1- Risco de 0 a 50 mm"
v_Para_Choques_Traseiro = "2- Raspado"
v_Parasol = ""
v_Porta_Traseira_Esq = ""
v_Porta_Traseira_Drt = ""


Observações = """Cadeira lateral não fecha 
Projector de video não funciona
Banco Condutor rasgado
Aviso de travões gastos 
                                                                                                                                                                                                                                                                 in                                                                                                                                                                                                                      terruptor do sensor da porta lateral solto """


Danos_Viatura = """Plastico dos espelhos batido
Parachoques raspado no canto esquerdo e direito"""


#       pyinstaller AB-Relatorio.py --onefile
...
seleccao_funcionamento = [Buzina, Esguichos_dos_lava_vidros, Luzes_minimos, Luzes_medios, Luzes_maximos, Luzes_stop, Luzes_marcha_atras, Luz_nevoeiro, Piscas_FR_TR, Rotativos_Ponte, Sirene, Iluminacao_chapa_matricula, Estoboscopios, Iluminacao_interior, Rádio_de_comunicações, Cintos, Retrovisores, Fechaduras, Travoes, Projetores_laterais]
...
#Para_Lamas_Esq = {"title": "3", "value": }
#Para_Lamas_Drt = {"title": "4", "value": }
#Tejadilho = {"title": "5", "value": }
...
#Porta_Lateral = {"title": "9", "value": } 
#resposta10 = {"title": "10", "value": Risco}
...
#Parasol = {"title": "14", "value": }
#Porta_Traseira_Esq = {"title": "15", "value": }
#Porta_Traseira_Drt = {"title": "16", "value": }


seleccao_riscos = [Para_Choques, Capô, Porta_Condutor, Porta_Passageiro, Painel_Esq, Traseira_Esq, Traseira_Drt, Para_Choques_Traseiro]
